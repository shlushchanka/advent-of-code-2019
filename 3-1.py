...
def iterate(visited, initial_position, direction, distance):
...
def visited_points(origin, wire_string):
  ...
  for w in wire:
    ...
    current_position = iterate(visited, current_position, direction, distance)
  return visited
...
if __name__ == '__main__':
  ...
  print(manhattan_distance_from_origin(p))
